...
- Import component values from `@partner-up-dev/ui-web` unless the consuming project has an explicit local alias.
- Import shared and component-specific TypeScript helper types from `@partner-up-dev/ui-web`.
...
- Do not import from `@partner-up-dev/ui-web/components/*`, `@partner-up-dev/ui-web/src/*`, generated registry internals, or raw implementation files.
