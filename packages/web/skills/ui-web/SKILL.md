---
name: ui-web
description: Use @partner-up-dev/ui-web Vue components correctly in application UI, including component selection, composition, props, slots, events, and package-specific caveats.
---
...
Use this skill when building Vue application UI with `@partner-up-dev/ui-web` or
...
- Import component values and TypeScript helper types from `@partner-up-dev/ui-web`.
